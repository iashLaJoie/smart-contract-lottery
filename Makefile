...
deploy-sepolia:
	@forge script script/DeployRaffle.s.sol:DeployRaffle --rpc-url $(SEPOLIA_RPC_URL) --account lottery-sepolia --broadcast --verify --etherscan-api-key $(ETHERSCAN_API_KEY) -vvvv
