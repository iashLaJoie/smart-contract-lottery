...
contract RaffleTest is Test, CodeConstants {
    ...
    function testRaffleRecordsPlayersWhenTheyEnter() public {
        ...
        vm.prank(PLAYER);
        // Act
        raffle.enterRaflle{value: entraceFee}();
    ...
    function testCheckUpkeepReturnsFalseIfRaflleIsNotOpen() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaflle{value: entraceFee}();
        vm.warp(block.timestamp + interval + 1);
    ...
    function testCheckUpkeetReturnsFalseIfNotEnoughTimeHasPassed() public {
        // Arrange
        vm.prank(PLAYER);
        raffle.enterRaflle{value: entraceFee}();
        vm.roll(block.number + 1);
